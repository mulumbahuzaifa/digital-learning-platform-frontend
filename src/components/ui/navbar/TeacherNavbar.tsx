          ...
          <Flex gap="5" align="center">
            ...
            <Box className="relative">
              <Link to="/teacher/classes">
                <BookmarkIcon width="20" height="20" className="text-gray-600 hover:text-blue-600" />
              </Link>
            </Box>

            <Box className="relative">
              <Link to="/teacher/gradebook">
                <BarChartIcon width="20" height="20" className="text-gray-600 hover:text-blue-600" />
              </Link>
            </Box>
            ...
            <DropdownMenu.Root>
              ...
              <DropdownMenu.Content>
                <DropdownMenu.Item>
                  <Link to="/teacher/profile" className="flex items-center gap-2 w-full">
                    <PersonIcon />
                    Profile
                  </Link>
                </DropdownMenu.Item>
                <DropdownMenu.Item>
                  <Link to="/teacher/settings" className="flex items-center gap-2 w-full">
                    <GearIcon />
                    Settings
                  </Link>
                </DropdownMenu.Item>
