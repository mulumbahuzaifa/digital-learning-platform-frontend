...
const LiveSessionDetail = () => {
  ...
  const handleStartSession = () => {
    if (id) startLiveSession.mutate(id);
  };

  const handleEndSession = () => {
    if (id) endLiveSession.mutate(id);
  };
      ...
      <Flex direction="column" gap="4">
        <Flex justify="between" align="center">
          ...
          <Flex gap="2">
            ...
            {!isTeacher && session.status === "live" && !isParticipant && (
              <Button
                color="blue"
        ...
        <Flex gap="4">
            ...
            <Flex direction="column" gap="3">
              ...
              {session.status === "scheduled" && (
                <Box>
                  ...
                  <Text>{session.meetingId}</Text>
                  <Text weight="bold" mt="1">
                    Password:
                  </Text>
                  <Text>{session.meetingPassword}</Text>
                </Box>
              )}
          ...
          <Card style={{ width: "70%" }}>
            <Flex direction="column" gap="3" height="100%">
              ...
              {session.status === "live" && session.settings.enableChat && (
                <>
                  <Heading size="3">
                    <Flex align="center" gap="2">
                      <ChatBubbleIcon />
